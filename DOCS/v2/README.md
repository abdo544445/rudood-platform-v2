...
| **[6. خريطة ملفات البوت والذكاء الاصطناعي والـ RAG](./خريطة_ملفات_البوت_والذكاء_الاصطناعي.md)** | خريطة تفصيلية لجميع ملفات محرك الذكاء الاصطناعي، نماذج pgvector، محرك البحث الدلالي RagService، وواجهات التحكم مع مخطط تدفق البيانات Mermaid. |
| **[7. الشرح الشامل لكود البوت ودوال الذكاء الاصطناعي والـ RAG](./شرح_كود_البوت_ودوال_الذكاء_الاصطناعي.md)** | تفكيك برمجي عميق وشامل لدوال AiService و RagService و BotController، معادلات التشابه الكوسيني، وإدارة الذاكرة مع أسئلة وإجابات نموذجية للدكتور. |
